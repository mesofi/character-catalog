...
public class CharacterFigure extends Figure {
  ...
  @EqualsAndHashCode.Exclude private String id; // identifier of the record.

  @EqualsAndHashCode.Exclude private String originalName; // Name of the character.
  ...
  @EqualsAndHashCode.Exclude private boolean brokenCloth; // Contains broken armor parts?.
  ...
  @EqualsAndHashCode.Exclude private boolean set; // Is it part of a set?.
