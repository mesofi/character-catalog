...
public class ApplicationExceptionHandlerTest {
  ...
  @Mock private CharacterFigureNotFoundException characterFigureNotFoundException;
  ...
  /**
   * {@link
   * ApplicationExceptionHandler#handleHttpMessageNotReadable(HttpMessageNotReadableException,
   * org.springframework.http.HttpHeaders, HttpStatusCode,
  ...
  public void should_verify_response_for_message_not_readable() {
    ...
    ResponseEntity<Object> response =
        exceptionHandler.handleHttpMessageNotReadable(
            httpMessageNotReadableException, null, HttpStatusCode.valueOf(404), webRequest);
  ...
  /**
   * {@link
   * ApplicationExceptionHandler#handleMethodArgumentNotValid(org.springframework.web.bind.MethodArgumentNotValidException,
   * org.springframework.http.HttpHeaders, HttpStatusCode,
   * org.springframework.web.context.request.WebRequest)}
   */
  @Test
  public void should_verify_response_for_argument_not_valid() {
    ...
    ResponseEntity<Object> response =
        exceptionHandler.handleMethodArgumentNotValid(
            methodArgumentNotValidException, null, HttpStatusCode.valueOf(404), webRequest);
    assertNotNull(response);
    ApiErrorResponse apiErrorResponse = (ApiErrorResponse) response.getBody();
    assertNotNull(apiErrorResponse);
    assertEquals("The error", apiErrorResponse.getMessage());
  ...
  /**
   * {@link ApplicationExceptionHandler#handleNotFound(CharacterFigureNotFoundException,
   * WebRequest)}
   */
  @Test
  public void should_verify_response_for_handle_not_found() {
    ...
    ResponseEntity<Object> response =
        exceptionHandler.handleNotFound(characterFigureNotFoundException, webRequest);
    assertNotNull(response);
    ApiErrorResponse apiErrorResponse = (ApiErrorResponse) response.getBody();
    assertNotNull(apiErrorResponse);
    assertEquals("The error", apiErrorResponse.getMessage());
  ...
  public void should_verify_response_for_handle_bad_request() {
    ...
    ResponseEntity<Object> response =
        exceptionHandler.handleBadRequest(illegalArgumentException, webRequest);
    assertNotNull(response);
    ApiErrorResponse apiErrorResponse = (ApiErrorResponse) response.getBody();
    assertNotNull(apiErrorResponse);
    assertEquals("The error", apiErrorResponse.getMessage());
  ...
  public void should_verify_response_for_handle_generic_error() {
    ...
    ResponseEntity<Object> response =
        exceptionHandler.handleGenericError(runtimeException, webRequest);
    assertNotNull(response);
    ApiErrorResponse apiErrorResponse = (ApiErrorResponse) response.getBody();
    assertNotNull(apiErrorResponse);
    assertEquals("The error", apiErrorResponse.getMessage());
