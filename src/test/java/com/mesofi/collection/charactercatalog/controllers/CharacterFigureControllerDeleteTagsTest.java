...
/**
 * Test for {@link CharacterFigureController#deleteAllTagsInCharacter(String)}
 * 
 * @author armandorivasarzaluz
 *
 */
@WebMvcTest(CharacterFigureController.class)
public class CharacterFigureControllerDeleteTagsTest {
    ...
    @Test
    public void should_fail_delete_tags_when_method_not_supported1() throws Exception {
        // @formatter:off
    ...
    @Test
    public void should_fail_delete_tags_when_method_not_supported2() throws Exception {
    ...
    @Test
    public void should_fail_delete_tags_when_not_found() throws Exception {
        String id = "65215079a5d1a04590202d71";
        String url = BASE_URL + "/{id}/";
        // @formatter:off
        mockMvc.perform(delete(url, id))
    ...
    @Test
    public void should_delete_tags_successfully() throws Exception {
        String id = "65215079a5d1a04590202d71";
        ...
        when(characterFigureService.deleteAllTagsInCharacter(id)).thenReturn(actual);
